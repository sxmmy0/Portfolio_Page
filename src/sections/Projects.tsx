  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto">I built these projects to showcase my skills and experience.</p>
              ...
              <div className="absolute inset-0 -z-10 opacity-5" 
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                  <div className="lg:pb-16">
                    ...
                    <h3 className="font-serif text-2xl mt-2 md:mt-5 md:text-4xl lg:mt-8">
                      {project.title}
                    </h3>
                    <hr className="border-t-2 border-white/5 mt-4 md:mt-5 lg:mt-8" />
                    ...
                    <a href={project.link}>
                      <button className="bg-white text-gray-950 h-12 w-full lg:w-auto px-6 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8">
